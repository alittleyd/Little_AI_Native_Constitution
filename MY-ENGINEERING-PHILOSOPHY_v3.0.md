...
> **跨领域的工程真理**：标准不是设计出来的，是被事故逼出来的。

**1912 年 4 月 15 日，泰坦尼克号沉没**：
- 船上 2,224 人，仅 710 人获救
- 救生艇容量：1,178 人（仅够 53%）
- 实际登船：710 人（救生艇利用率仅 60%）

**为什么救生艇不够？**

不是技术问题，是**标准问题**：
- 当时的英国法律（1894 年商船法）：救生艇容量按**吨位**计算，不按**人数**
- 泰坦尼克号 46,328 吨，法律要求最少 16 艘救生艇
- 实际配备 20 艘，**已经超标**

**灾难后的改变**：

1914 年《国际海上人命安全公约》(SOLAS)：
- ✅ 救生艇容量必须 ≥ 船上所有人数
- ✅ 强制 24 小时无线电值守
- ✅ 定期救生演习
- ✅ 冰区航行限速

**现代救生艇的每一个设计，都是对 1912 年那场灾难的"补丁测试"。**
...
| 领域 | 泰坦尼克号（交通工程） | 软件工程 |
|------|---------------------|---------|
| **灾难前的标准** | 按吨位配救生艇 | "能跑就行"、"先上线再说" |
| **责任等级** | 人命 | 用户数据、业务连续性 |
| **灾难事件** | 1,514 人遇难 | 数据泄露、系统崩溃、资金损失 |
| **灾难后的标准** | SOLAS 公约（按人数配救生艇） | GDPR、SOC2、ISO 27001 |
| **核心教训** | **标准必须与责任等级一致** | **标准必须与责任等级一致** |

**为什么这个类比很重要？**

1. **工程标准不是"最佳实践"，是"最低要求"**
   - 泰坦尼克号已经"超标"，但标准本身就是错的
   - 软件工程中，"通过测试"不等于"安全可靠"

2. **标准的代价是用血换来的**
   - 交通工程：每一条安全规范背后都有事故
   - 软件工程：每一个安全标准背后都有数据泄露

3. **你的工程标准，取决于你愿意承担什么后果**
   - Level 1 (Demo): 能跑就行 → 后果：演示失败
   - Level 2 (Production): 可观测 + 容错 → 后果：用户投诉
   - Level 3 (Mission-Critical): 高可用 + 灾备 → 后果：人命/巨额损失

**典总的洞察**：

> **工程世界里，标准不是设计出来的，是被事故逼出来的。**  
> 
> 泰坦尼克号教会我们：  
> - 不要等灾难发生才提高标准  
> - 不要用"已经超标"来安慰自己  
...
- 你做 Demo？Level 1 就够了。
- 你做生产系统？Level 2 是底线。
- 你做金融/医疗/交通？Level 3 是救命的。

**不要等你的"泰坦尼克号"沉了，才去加救生艇。**
